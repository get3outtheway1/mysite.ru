<?php 
	$scolax_hs_slider		= get_theme_mod('hide_show_slider','on');
	if( $scolax_hs_slider == 'on' ): 
?>
...
<?php if(!empty($id_arr))
	{ ?>
	<section id="slider-section" class="slider-wrapper-scolax slider-section-scolax">
		<div class="main-slider-scolax arrows-small arrows-transparent" data-slider-id="1">
							...
							<div class="specia-table-cell">
								<div class="container">                                
									<div class="specia-content">
										...
										<a data-animation="fadeInUp" data-delay="850ms" href="<?php echo esc_url( get_post_meta( get_the_ID(),'slidebuttonlink', true) ); ?>" class="global-btn"><?php echo esc_html( get_post_meta( get_the_ID(),'slidebutton', true) ); ?>
